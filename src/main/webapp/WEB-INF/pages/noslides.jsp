...
<link rel="stylesheet" href="/ETS/css/styles.css" type="text/css" />
<!--
...
<script type="text/javascript" src="/ETS/js/slider.js"></script>
<script type="text/javascript" src="/ETS/js/superfish.js"></script>

<script type="text/javascript" src="/ETS/js/custom.js"></script>
            ...
            <ul>	
              <li>
				...
				<ul>
					...
					<li><a class="selected" href="noslides.html">No slides page</a></li>
				</ul>
			</li>
